...
config :root_mcp, Root.Repo,
  database: Path.expand("../root_mcp_dev.db", __DIR__),
  pool_size: 5,
  stacktrace: true,
...
config :root_mcp, RootWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "xbQBPUhVVfb8zUYFY6uNXT+VceXKChWb/kB2eij84gLYsj1GfaSm8s8vAT3CwxLY",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:root_mcp, ~w(--sourcemap=inline --watch)]},
...
config :root_mcp, dev_routes: true
